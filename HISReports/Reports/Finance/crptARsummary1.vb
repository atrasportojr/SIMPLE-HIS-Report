...
Public Class crptARsummary1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptARsummary1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptARsummary1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptARsummary1 = New crptARsummary1()
        rpt.Site = Me.Site
        Return rpt
    End Function

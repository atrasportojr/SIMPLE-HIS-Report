...
Public Class crptAgedPayables
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptAgedPayables.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptAgedPayables
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptAgedPayables = New crptAgedPayables()
        rpt.Site = Me.Site
        Return rpt
    End Function

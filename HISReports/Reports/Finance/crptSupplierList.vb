...
Public Class crptSupplierList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptSupplierList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptSupplierList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptSupplierList = New crptSupplierList()
        rpt.Site = Me.Site
        Return rpt
    End Function

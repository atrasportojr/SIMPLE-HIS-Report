...
Public Class crptNursingNotes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptNursingNotes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptNursingNotes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptNursingNotes = New crptNursingNotes()
        rpt.Site = Me.Site
        Return rpt
    End Function

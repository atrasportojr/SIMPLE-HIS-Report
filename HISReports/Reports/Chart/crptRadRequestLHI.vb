...
Public Class crptRadRequestLHI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptRadRequestLHI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptRadRequestLHI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptRadRequestLHI = New crptRadRequestLHI()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class crptTestRequestLHI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptTestRequestLHI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptTestRequestLHI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptTestRequestLHI = New crptTestRequestLHI()
        rpt.Site = Me.Site
        Return rpt
    End Function

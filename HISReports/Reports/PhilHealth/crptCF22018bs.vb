...
Public Class crptCF22018bs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptCF22018bs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptCF22018bs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptCF22018bs = New crptCF22018bs()
        rpt.Site = Me.Site
        Return rpt
    End Function

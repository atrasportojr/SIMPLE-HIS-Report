...
Public Class crptCF22018as
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptCF22018as.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptCF22018as
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptCF22018as = New crptCF22018as()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class crptClearance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptClearance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptClearance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptClearance = New crptClearance()
        rpt.Site = Me.Site
        Return rpt
    End Function

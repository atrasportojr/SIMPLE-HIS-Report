...
Public Class crptPatientsIndex
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptPatientsIndex.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptPatientsIndex
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptPatientsIndex = New crptPatientsIndex()
        rpt.Site = Me.Site
        Return rpt
    End Function

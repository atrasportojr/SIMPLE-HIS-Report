...
Public Class crptOperationIndex
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptOperationIndex.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptOperationIndex
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptOperationIndex = New crptOperationIndex()
        rpt.Site = Me.Site
        Return rpt
    End Function

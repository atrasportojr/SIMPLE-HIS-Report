...
Public Class crptDailyCensus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptDailyCensus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptDailyCensus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptDailyCensus = New crptDailyCensus()
        rpt.Site = Me.Site
        Return rpt
    End Function

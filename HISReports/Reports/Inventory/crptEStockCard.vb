...
Public Class crptEStockCard
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HISReports.crptEStockCard.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptEStockCard
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptEStockCard = New crptEStockCard()
        rpt.Site = Me.Site
        Return rpt
    End Function
